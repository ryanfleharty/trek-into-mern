...
export default class EpisodesContainer extends Component {
    ...
    createEpisode = async (e) => {
        e.preventDefault();
        const newEpisode = await fetch(`${process.env.REACT_APP_BACKEND_ADDRESS}/episodes`, {
            method: "POST",
            credentials: 'include',
    ...
    getEpisodes = async () => {
        const episodes = await fetch(`${process.env.REACT_APP_BACKEND_ADDRESS}/episodes`, {
            credentials: 'include'
        });
    ...
    deleteEpisode = async(id, e) => {
        ...
        const deleteSuccess = await fetch(`${process.env.REACT_APP_BACKEND_ADDRESS}/episodes/` + id, {
            method: "DELETE",
            credentials: 'include'
        })
    ...
    updateEpisode = async (episodeData) => {
        ...
        const updatedEpisode = await fetch(`${process.env.REACT_APP_BACKEND_ADDRESS}/episodes/` + episodeData._id, {
            method: "PUT",
            headers: {
                'Content-Type': 'application/json'
            },
